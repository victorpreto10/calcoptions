...
if st.session_state.selected_category == "Arbitragem":
    ...
    opcao_opcoes = st.sidebar.radio(
        "Opções:",
        ('XML Opção', 'Consolidado opções', 'Notional to shares', 'Planilha SPX', 'Pegar Volatilidade Histórica', 'Pegar Open Interest','Pegar Open Interest2', 'Calcular Preço de Opções', 'Calcular Volatilidade Implícita')
    )
